...
// POST REQUEST
function addTodo() {
    axios.post("https://jsonplaceholder.typicode.com/todos?_limit=5",{title:"new addTodo",completed:false})
    .then(res=>showOutput(res))
    .catch(err=>console.log(err))
}
...
// PUT/PATCH REQUEST
function updateTodo() {
    axios.patch("https://jsonplaceholder.typicode.com/todos/1",{title:"updated addTodo",completed:true})
    .then(res=>showOutput(res))
    .catch(err=>console.log(err))
}
// DELETE REQUEST
...
function customHeaders() {
  ...
  axios.post("https://jsonplaceholder.typicode.com/todos",{title:"new addTodo",completed:false},config)
    .then(res=>showOutput(res))
    .catch(err=>console.log(err))
}
