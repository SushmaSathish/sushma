    ...
    if (editId) {
      try {
        let value = await axios.put(
          `https://crudcrud.com/api/0c7d9506151a45ccaf79817d22310b29/OrderData/${editId} `,
          obj
        );
      ...
      try {
        let res = await axios.post(
          `https://crudcrud.com/api/0c7d9506151a45ccaf79817d22310b29/OrderData`,
          obj
        );
        console.log(res);
...
async function showOrderOnUI(ID) {
  try {
    ...
    let res = await axios.get(
      `https://crudcrud.com/api/0c7d9506151a45ccaf79817d22310b29/OrderData/${ID}`
    );
...
document.addEventListener("DOMContentLoaded", async () => {
  try {
    let res = await axios.get(
      `hhttps://crudcrud.com/api/0c7d9506151a45ccaf79817d22310b29/OrderData`
    );
